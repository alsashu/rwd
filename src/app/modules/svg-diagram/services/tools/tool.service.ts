...
import { IZoomScrollService } from "../zoom-scroll/zoom-scroll.service";
...
export class ToolService {
  ...
  public diagramService: ISvgDiagramService;
  public zoomScrollService: IZoomScrollService;
  ...
  constructor(public toolManager: ToolManager) {
    this.diagramService = this.toolManager.svgDiagramService;
  ...
  public getSvgDiagramComponent() {
    return this.diagramService.svgDiagramComponent;
  }
  ...
  // Utils
  public refresh() {
    // TODO this.diagramService.refresh();
  }

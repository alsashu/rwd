...
import { OnBoardPhysicalArchitectureDiagramFactory } from "../factories/onboard-physical-arch-diagram-factory";
import { GraphicViewComponent } from "../graphic-view.component";
import { ISubTypeDiagramController } from "./idiagram-controller";

export class OnBoardPhysicalArchitectureDiagramController implements ISubTypeDiagramController {
  private diagramFactory: OnBoardPhysicalArchitectureDiagramFactory;

  constructor(private graphicViewComponent: GraphicViewComponent) {
    this.diagramFactory = new OnBoardPhysicalArchitectureDiagramFactory(graphicViewComponent);
  }

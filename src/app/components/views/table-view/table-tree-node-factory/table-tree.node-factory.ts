...
import { MainTableTreeRule } from "./table-tree-rules/main.table-tree-rule";
 ...
 */
export class TableTreeNodeFactory extends RulesNodeFactory implements IRulesNodeFactory {
  constructor(protected treeMemoService: ITreeMemoService, params: any) {
    super(treeMemoService, params);
    this.params.mainRule = new MainTableTreeRule(this);
  }
}

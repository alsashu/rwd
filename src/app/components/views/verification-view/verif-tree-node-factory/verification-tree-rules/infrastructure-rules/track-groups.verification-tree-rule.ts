...
export class TrackGroupsVerificationTreeRule extends ANodeFactoryRule {
  private params: any = {
    nodesConfig: [
      {
        id: "TrackGroups",
  ...
  public buildNodes(object: any, parentNode: any, context: any, params: any = null): any[] {
    ...
    if (
      ...
      this.rulesNodeFactory.testIfContextUnderObjetsTypes(context, 0, ["trackGroups"]) // TODO OPTIM
    ) {
      // if (object.type === "line") {
      //   console.log(">> line", object);
      // }
      // if (this.rulesNodeFactory.isTypeExtensionOfTypes(object.type, this.params.linesConfig.types)) {
      //   console.log(">> track group", object.type);
      // }
      ...
      //   object,
      //   context,
      //   this.params.linesConfig.types,
      //   this.params.linesConfig.categoryId,

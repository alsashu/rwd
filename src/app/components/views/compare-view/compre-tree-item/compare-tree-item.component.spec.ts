...
import { CompareTreeItemComponent } from "./compare-tree-item.component";

describe("CompareTreeItemComponent", () => {
  let component: CompareTreeItemComponent;
  let fixture: ComponentFixture<CompareTreeItemComponent>;
  let servicesService: IServicesService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [CompareTreeItemComponent, GenericTreeComponent, GenericContextMenuComponent],
      imports: [
        HttpClientModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CompareTreeItemComponent);

 ...
 * Groupable objects
 */
export class GroupableObjectsCompareTreeMenuRule extends ANodeFactoryRule {
  private params: any = {
  ...
  public buildNodes(object: any, parentNode: any, context: any, params: any = null): any[] {
    ...
    if (
      ...
      if (this.rulesNodeFactory.isTypeExtensionOfTypes(object.type, ["tGraphicalGroupableElement"])) {

...
export class TracksCompareTreeRule extends ANodeFactoryRule {
  private params: any = {
    nodesConfig: [
      {
        id: "Tracks",
  ...
  public buildNodes(object: any, parentNode: any, context: any, params: any = null): any[] {
    ...
    if (
      ...
      context.project &&
      context.project.id &&
      this.rulesNodeFactory.testIfContextUnderObjetsTypes(context, 0, ["tracks"])
    ) {

...
/**
 * Controller for Trackside Physical Architecture Svg Diagrams
 */
export class TracksidePhysicalArchitectureSvgDiagramController extends ASubTypeSvgDiagramController {
  /**
   * Constructor

import { Directive, OnDestroy, AfterViewInit, ElementRef,
  HostListener, Input, Output, EventEmitter, NgZone, } from '@angular/core';
import { DomHandler } from '../directives/domhandler';
